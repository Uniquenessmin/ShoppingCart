	...
	<nav class="navbar navbar-expand-sm navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavId">
			...
			<form class="form-inline my-2 my-lg-0" action="search.jsp"
				method="post">
				<input class="form-control mr-sm-2" type="type" name="text" value=""
					placeholder="三只松鼠">
	...
	<form action="" method="post">
		<table class="table">
			<tbody>
				<tr>
					<!-- 遍历商品的全部信息 -->
					<%	out.println("搜索关键字："+text);
					
						ProductController p = new ProductController();
						ArrayList<Product> list = p.getProduct(text);
					...
					<td><dd>
						...
						<dd>
							商品价格：￥<%=price%></dd> <br>
						<dd>
							<a class="btn btn-primary" href="shopcart.jsp?op=add&pid=<%=id%>"
								role="button">加入购物车</a> <a class="btn btn-danger" href="pay.jsp"
								role="button">立即支付</a>
						</dd>
						<dd>
							<div class="row">
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a class="btn btn-primary"
														href="shopcart.jsp?op=add&pid=<%=id%>" role="button">加入购物车</a>
												</div>
											</div>
										</div>
									</div>
